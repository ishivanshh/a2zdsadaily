...
// third approch => Dutch National Flag Algorithm (Single Pass)
// Time Complexity: O(n),We traverse the array once. space complexity: O(1)

class Solution3 {
    public :
    int dutchSorted(vector <int>& arr){
        int low = 0;
        int mid = 0;
        int high = arr.size() - 1;
